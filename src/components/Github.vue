<template lang="pug">
  a.github-corner(href="https://github.com/shinjuku-lt/shinjuku-lt-website" aria-label="View source on Github")
    svg(width="80" height="80" viewBox="0 0 250 250" style="fill:#fff; color:rgb(36, 31, 62); position: absolute; top: 0; border: 0; right: 0; z-index: 1;" aria-hidden="true")
